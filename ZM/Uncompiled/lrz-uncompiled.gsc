...
tp_transit_pap()
{
    self setorigin( ( 2276.0, -152.0, -304 ) );
...
zpp_initServerDvars() //credits to JezuzLizard!!! This is a huge help in making this happen
{
	...
	level.round_number = getDvarIntDefault( "LRZ2_roundNumber", 1 );
