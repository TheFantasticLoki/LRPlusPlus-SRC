...
onspawnplayer( predictedspawn ) //modified function
{
	...
	if ( !isDefined( spawnpoint ) )
	{
		...
		else if ( getDvar("CUSTOM_MAP") == "town" )
		{
		...
		else if ( getDvar("CUSTOM_MAP") == "farm" )
		{
...
get_player_spawns_for_gametype() //modified function
{
	...
	else if( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "cellblock")
	{
	...
	else if( isdefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "maze" )
	{
	...
	else if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "crazyplace" )
	{
	...
	else if ( isdefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "excavation" )
	{
