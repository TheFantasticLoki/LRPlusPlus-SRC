...
perk_machine_spawn_init() //modified function
{
	...
	if ( isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "cornfield" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
	...
	else if ( isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "power" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
	...
	else if ( isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP =="diner" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
	...
	else if ( isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "tunnel" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
	...
	else if ( getDvar("CUSTOM_MAP") == "farm" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
	...
	else if ( getDvar("CUSTOM_MAP") == "busdepot" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic)
	{
