...
init_magicbox() //modified function
{
	...
	if ( is_classic() )
	{
		...
		if (isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "docks")
		{
			level.chests = [];
		...
		else if (isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "showers")
		{
			level.chests = [];
			start_chest = spawnstruct();
...
get_chest_pieces() //modified function
{
	...
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "docks" && self.script_noteworthy == "start_chest" )
	{
		self.chest_box.origin = ( -423.33, 6952, 64.125 );
		self.chest_box.angles = ( 0, 10, 0 );
	}
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "rooftop" && self.script_noteworthy == "start_chest" )
	{
		self.chest_box.origin = ( 2249, 9869.5, 1704.1 );
		self.chest_box.angles = ( 0, -90, 0 );
	}
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "showers" && self.script_noteworthy == "start_chest" )
	{
