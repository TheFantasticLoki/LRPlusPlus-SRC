...
get_chest_pieces() //modified function
{
	...
	if ( isdefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "crazyplace" && self.script_noteworthy == "bunker_start_chest" )
	{
		self.chest_box.origin = ( 9615, -8120, -464 );
		self.chest_box.angles = ( 0, 125, 0 );
	}
	if ( isdefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "crazyplace" && self.script_noteworthy == "bunker_tank_chest" )
	{
