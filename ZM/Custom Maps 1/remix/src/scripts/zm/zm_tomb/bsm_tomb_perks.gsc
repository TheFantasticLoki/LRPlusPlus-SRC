...
perk_machine_spawn_init() //modified function
{
	...
	while ( i < structs.size )
	{
		...
		if ( isdefined( structs[ i ].script_string ) )
		{
			...
			while ( k < tokens.size )
			{
				...
				{
					if(is_true(level.CUSTOM_MAP == "trenches") )
					{
					...
					else if( is_true(level.CUSTOM_MAP == "crazyplace") )
					{
					...
					else if( is_true(level.CUSTOM_MAP == "excavation") )
					{
	...
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "trenches" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
	...
	else if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "crazyplace" && isdefined(level.disableBSMMagic) && !level.disableBSMMagic )
	{
								print("crazy");
