...
init_magicbox() //modified function
{
	...
	if ( is_classic() )
	{
		...
		if (isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "building1top" )
		{
			level.chests = [];
		...
		else if (isDefined(level.CUSTOM_MAP) && level.CUSTOM_MAP == "redroom" )
		{
			level.chests = [];
			start_chest = spawnstruct();
...
get_chest_pieces() //modified function
{
	...
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "building1top" && self.script_noteworthy == "ob6_chest" )
	{
		self.chest_box.origin = (1608.58, 1053.19, 3221.79);
		self.chest_box.angles = (0, 0, 0);
	}
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "building1top" && self.script_noteworthy == "start_chest" )
	{
		self.chest_box.origin = (2177.11, 2416.36, 3040.13);
		self.chest_box.angles = (0, 180, 0);
	}
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "redroom" && self.script_noteworthy == "start_chest" )
	{
		self.chest_box.origin = ( 3731.95, 1817.7, 1430.5 );
		self.chest_box.angles = ( 0, 90, 0 );
	}
	if ( isDefined( level.CUSTOM_MAP ) && level.CUSTOM_MAP == "redroom" && self.script_noteworthy == "gb1_chest" )
	{
